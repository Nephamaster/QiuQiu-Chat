...
void TitleBar::initControl()
{
    ...
    m_pButtonMin->setStyleSheet("border-image: url(:/image/toolicon/min.png); border-style: flat;");
    m_pButtonRestore->setStyleSheet("border-image: url(:/image/toolicon/restore.png); border-style: flat;");
    m_pButtonMax->setStyleSheet("border-image: url(:/image/toolicon/max.png); border-style: flat;");
    m_pButtonClose->setStyleSheet("border-image: url(:/image/toolicon/close.png); border-style: flat;");
    ...
    mylayout->setContentsMargins(10, 10, 10, 10);
...
{
    QPixmap titleIcon(QString(":/image/toolicon/%1").arg(filePath));
...
void TitleBar::setTitleContent(QString titleContent, int titleFontSize)
{
    ...
    m_pTitleContent->setStyleSheet(QString("color: rgb(255,255,255);"
